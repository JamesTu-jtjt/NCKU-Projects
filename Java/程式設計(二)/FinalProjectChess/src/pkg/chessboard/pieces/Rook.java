...
public class Rook extends Piece {
	...
	public Rook(final int piecePos, final ColorOfPieces pieceCol) {
		super(PieceType.ROOK, piecePos, pieceCol, true);
	}
	
	public Rook(final int piecePos, final ColorOfPieces pieceCol,final boolean firstMove) {
		super(PieceType.ROOK, piecePos, pieceCol, firstMove);
	}
	...
	public Rook movePiece(final Move move) {
		// TODO Auto-generated method stub
		return new Rook(move.getDestinationCoordinate(), move.getMovedPiece().getPieceCol());
	}
